namespace TweeterTotters
{
    ...
    /// <summary>
    /// This is the custom implementation of RelayCommand implemented by Microsoft MVP, Josh Smith.
    ...
    /// <summary>
    /// This is the custom implementation of RelayCommand written by Microsoft MVP, Josh Smith.
    /// A command whose sole purpose is to relay its functionality to other objects by
    /// invoking delegates. The default return value for the CanExecute method is 'true'.
    /// </summary>
